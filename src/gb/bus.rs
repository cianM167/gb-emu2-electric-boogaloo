...
impl Bus {
    ...
    pub fn write(&mut self, addr: u16, value: u8) {
        match addr {
            ...
            0xFF11 => self.apu.set_channel_duty(Ch1, value),
            0xFF12 => self.apu.ch1.write_envelope(value),
            0xFF13 => self.apu.set_channel_freq_lo(Ch1, value),
            0xFF14 => {
            ...
            0xFF16 => self.apu.set_channel_duty(Ch2, value),
            0xFF17 => self.apu.ch2.write_envelope(value),
            0xFF18 => self.apu.set_channel_freq_lo(Ch2, value),
            0xFF19 => {
            ...
            0xFF1B => self.apu.set_channel_duty(Ch3, value),
            0xFF1C => self.apu.ch3.write_envelope(value),
            0xFF1D => self.apu.set_channel_freq_lo(Ch3, value),
            0xFF1E => {
            ...
            0xFF20 => self.apu.set_channel_duty(Ch4, value),
            0xFF21 => self.apu.ch4.write_envelope(value),
            0xFF22 => self.apu.set_channel_freq_lo(Ch4, value),
            0xFF23 => {
